...
from PyQt6.QtWidgets import QWidget, QGroupBox, QFormLayout, QLabel, QPushButton, QComboBox, QVBoxLayout, QLineEdit, QHBoxLayout, QFrame
# custom packages
...
class DynamicMode(QWidget):
    ...
    def init_ui(self, mode):
        ...
        # Type of experiment.
            ...
            self.experiment_type_layout.addRow(experiment_type_label, self.experiment_type)
            if self.power_supply is not None:
                self.experiment_type.currentIndexChanged.connect(self.experiment_type_changed)
            self.control_panel_layout.addLayout(self.experiment_type_layout)
        # -------------------------------------------------------------------------------------------------------- #
        ...
        self.power_supply_control = Dynamic_PS(self.power_supply, mode=mode)
