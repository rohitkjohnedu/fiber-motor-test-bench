...
''' Based on the old mode 5'''

class MainMode(QWidget):
    def __init__(self, parent=None):
        ...
        # ************************************************************************************************************ #
        self.mode_groupBox = QGroupBox("Multiple outputs in Unipolar")
        self.mode_groupBox.setStyleSheet('QGroupBox {font-weight: bold;}')
        self.mode_groupBox.setFixedWidth(680)
        # ------------------------------------------------------------------------------------------------------------ #
        self.mode_layout = QVBoxLayout(self)
        self.mode_layout.addWidget(self.mode_groupBox)
        # ------------------------------------------------------------------------------------------------------------ #
        self.mode_groupBox_layout = QGridLayout(self.mode_groupBox)
        self.mode_groupBox_layout.setHorizontalSpacing(25)
        ...
        # ------------------------------------------------------------------------------------------------------------ #
        self.hb_number_label = QLabel("Phase number")
        ...
        # ------------------------------------------------------------------------------------------------------------ #
        self.mode_groupBox_layout.addWidget(self.hb_number_label, 0, 0, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_freq_label, 0, 1, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_pos_duty_label, 0, 2, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_neg_duty_label, 0, 3, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_pulse_phase_label, 0, 4, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_phase_shift_label, 0, 5, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_on_off_label, 0, 6, Qt.AlignmentFlag.AlignCenter)
        # ************************************************************************************************************ #
        ...
        # ------------------------------------------------------------------------------------------------------------ #
        self.mode_groupBox_layout.addWidget(self.hb_comboBox, 1, 0, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_freq_edit, 1, 1, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_pos_duty_edit, 1, 2, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_neg_duty_edit, 1, 3, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_pulse_phase_edit, 1, 4, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.hb_phase_shift_edit, 1, 5, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.change_btn, 1, 6, Qt.AlignmentFlag.AlignCenter)
        # ------------------------------------------------------------------------------------------------------------ #
        ...
        # ------------------------------------------------------------------------------------------------------------ #
        self.mode_groupBox_layout.addWidget(self.t_switch_label, 2, 0, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.t_switch_edit, 2, 1, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.sequence_time_label, 2, 2, Qt.AlignmentFlag.AlignCenter)
        self.mode_groupBox_layout.addWidget(self.sequence_time_edit, 2, 3, Qt.AlignmentFlag.AlignCenter)
        # ------------------------------------------------------------------------------------------------------------ #
        # ACTIONS
