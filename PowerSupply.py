...
class PowerSupply(QWidget):
    def __init__(self, parent=None, port_name=None, estimate_rate=None, currents_display=None, voltage_display=None,
        ...
        self.ser.reset_input_buffer()                                         # can't use the port which is not open
        # ------------------------------------------------------------------------------------------------------------ #
        # Enable debug
        to_send = "QName\r\n"
    ...
    def init_vi(self):
        ...
        # # ------------------------------------------------------------------------------------------------------------ #
        # if self.display_voltages != 0:
        #     layout_right.addWidget(self.hv_plots)
        # # ------------------------------------------------------------------------------------------------------------ #
        # if self.display_voltages == 2:
        #     layout_right.addWidget(self.lv_plots)
        ...
        # # ------------------------------------------------------------------------------------------------------------ #
        # if self.display_currents == 1:
        #     layout_right.addWidget(self.all_cm_plots)
        # elif self.display_currents == 2:
    ...
    def data_reader_callback(self):
        ...
        if self.display_voltages != 0:
            ...
            self.hv_set_value_label.setText("{} V".format(self.hv_set_now, '4.2f'))
            self.hv_vm_value_label.setText("{} V".format(self.hv_vm_now, '4.2f'))
            self.hv_err_value_label.setText("{} V".format(self.hv_err_now, '4.2f'))
            # self.update_label(label1=self.hv_set_now, label2=self.hv_vm_now, label3=self.hv_err_now)
        # ------------------------------------------------------------------------------------------------------------ #
        # if self.display_voltages == 2:
        ...
        if self.display_currents == 3:
            ...
            for HalfBridges in range(nbHalfBridges):
                ...
                self.y_value_label.setText("{} uA".format(self.cm_val_now[HalfBridges+1], '9f'))
